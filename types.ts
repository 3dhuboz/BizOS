import type { BusinessType, BusinessLabels, BusinessFeatures, AiPersona } from './utils/businessConfig';
...
export interface AppSettings {
  ...
  // Business Config (universal platform)
  businessType?: BusinessType;
  businessLabels?: Partial<BusinessLabels>;
  ...
  contractSettings?: {
    ...
    requireSignatureBeforeDeposit: boolean;
  };
}

// ─── New Entity Types (Universal Platform) ───────────────────
...
export interface SharedPlanResponse {
  ...
  dietaryPreferences?: string;
  headcount: number;
  itemVotes?: Record<string, 'up' | 'down'>;
  notes?: string;
  createdAt: string;
}
