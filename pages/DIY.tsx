...
import { ChefHat, Users, Clock, ArrowRight, Calendar, CheckCircle, AlertCircle, ShoppingCart, Truck, MapPin, Flame, Snowflake, CreditCard, Lock, Package, Info, Plus, Minus, ArrowLeft, Edit3, ShieldCheck, DollarSign, Check, ChevronUp, ChevronDown, X, Utensils, Ticket, Trash2, Coffee, Cake, Smartphone } from 'lucide-react';
  ...
  return (
    <div className="animate-in fade-in duration-700 pb-20">
       ...
       <div className="max-w-6xl mx-auto px-4">
         ...
         {/* STEP 3: CUSTOMER DETAILS */}
         {step === 3 && (
             <div className="max-w-2xl mx-auto bg-bbq-charcoal p-8 rounded-xl border border-gray-800 animate-in slide-in-from-right-8 shadow-xl">
                 <h2 className="text-2xl font-bold mb-6 text-white text-center">Your Details</h2>
                 <div className="space-y-5">
                     <div>
                         <label className="block text-gray-400 mb-2 text-sm font-bold">Full Name</label>
                         <div className="relative">
                             <Users className="absolute left-3 top-3.5 text-bbq-red" size={20} />
                             <input
                                 type="text"
                     ...
                     <div>
                         <label className="block text-gray-400 mb-2 text-sm font-bold">Phone Number</label>
                         <div className="relative">
                             <Smartphone className="absolute left-3 top-3.5 text-bbq-red" size={20} />
                             <input
                                 type="tel"
                                 value={customerPhone}
                     ...
                     <div>
                         ...
                         <div className="relative">
                             <Edit3 className="absolute left-3 top-3.5 text-bbq-red" size={20} />
                             <input
                                 type="email"
                                 value={customerEmail}
                     ...
                     <div>
                         <label className="block text-gray-400 mb-2 text-sm font-bold">Event Address</label>
                         <div className="relative">
                             <MapPin className="absolute left-3 top-3.5 text-bbq-red" size={20} />
                             <input
                                 type="text"
                 ...
                 <button
                     onClick={() => setStep(4)}
                     disabled={!customerName || !customerPhone || !customerEmail || !customerAddress}
                     className="w-full bg-white text-black font-bold py-4 rounded hover:bg-gray-200 disabled:opacity-50 transition shadow-lg mt-8 text-lg"
                 >
                     Next: Authorize Deposit <ArrowRight className="inline ml-2" size={20}/>
                 </button>
                 <div className="text-center mt-4">
                     <button onClick={() => { setStep(2); setSelectionMode('CHOICE'); }} className="text-gray-500 hover:text-white underline text-sm transition">Back to Menu</button>
                 </div>
             </div>
         )}
         ...
         {step === 4 && (
             <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 animate-in slide-in-from-right-8">
                 <div className="space-y-6">
                     ...
                     <button onClick={() => setStep(3)} className="text-gray-500 hover:text-white text-sm underline">Change Details</button>
