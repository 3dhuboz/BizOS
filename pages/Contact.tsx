        ...
        <div className="lg:col-span-5 bg-bbq-charcoal p-8 md:p-12 flex flex-col justify-between relative overflow-hidden">
            ...
            <div className="relative z-10 space-y-8">
                    ...
                    <div className="space-y-6">
                        <div className="flex gap-4">
                            ...
                            <div>
                                ...
                                <a href="mailto:admin@bizos.app" className="text-white text-lg font-bold hover:text-bbq-red transition">admin@bizos.app</a>
                            </div>
                        </div>
                        <div className="flex gap-4">
                            <div className="bg-black/40 w-12 h-12 flex items-center justify-center rounded-lg text-bbq-gold border border-white/5">
                ...
                <div className="flex gap-4 pt-4">
                    <a href="https://facebook.com/bizos" target="_blank" className="flex-1 bg-[#1877F2] py-3 rounded-lg text-white font-bold flex justify-center items-center gap-2 hover:opacity-90 transition">
                        <Facebook size={18}/> Facebook
                    </a>
                    <a href="https://instagram.com/bizos" target="_blank" className="flex-1 bg-gradient-to-tr from-yellow-500 to-purple-600 py-3 rounded-lg text-white font-bold flex justify-center items-center gap-2 hover:opacity-90 transition">
