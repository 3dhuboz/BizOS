...
const Events: React.FC = () => {
  ...
  const handleShare = (evt: any) => {
    if (navigator.share) {
      navigator.share({
        title: `BizOS: ${evt.title}`,
        text: `Catch BizOS at ${evt.location} on ${new Date(evt.date).toLocaleDateString()}!`,
          ...
          <div className="max-w-6xl mx-auto">
              <div className="text-center mb-10">
                  ...
                  <h2 className="text-4xl md:text-5xl font-display font-bold text-white uppercase">
                      Want BizOS at <span className="text-bbq-gold">Your Event?</span>
                  </h2>
