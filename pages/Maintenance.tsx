      ...
      <div className="relative z-10 text-center max-w-2xl mx-auto space-y-8 animate-in fade-in zoom-in duration-700">
        ...
        <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-8 shadow-2xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-left">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <a href="mailto:admin@bizos.app" className="font-bold hover:text-bbq-gold transition">admin@bizos.app</a>
                    </div>
                </div>
                <div className="flex items-center gap-4">
            ...
            <div className="flex justify-center gap-4 mt-8 pt-6 border-t border-white/10">
                <a href="https://facebook.com/bizos" target="_blank" className="p-3 bg-blue-600 rounded-full text-white hover:bg-blue-500 transition"><Facebook size={20}/></a>
                <a href="https://instagram.com/bizos" target="_blank" className="p-3 bg-pink-600 rounded-full text-white hover:bg-pink-500 transition"><Instagram size={20}/></a>
            </div>
        </div>
