    ...
    <div className="space-y-16 animate-in fade-in duration-700 relative">
      ...
      <section className="relative w-full h-[500px] overflow-hidden flex items-center justify-center my-12 group">
          ...
          <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
              ...
              <p className="text-gray-200 text-lg md:text-xl font-medium max-w-3xl mx-auto mb-8 leading-relaxed drop-shadow-md">
                  We fire up the grill and serve up mouth-watering BBQ at festivals, rodeos, markets, and private events. Wherever the crowd is, BizOS brings the flavour, the fun, and the smoke!
              </p>
      ...
      <section className="relative max-w-5xl mx-auto px-6 py-12 text-center">
         ...
         <p className="text-gray-400 text-lg md:text-xl leading-relaxed font-light max-w-3xl mx-auto">
            BizOS is a family owned operation obsessed with the ritual of fire and meat. We treat every brisket with respect, smoking it for 12+ hours over seasoned Ironbark until it falls apart at the sight of a fork. This isn't just lunch—it's a religious experience.
         </p>
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-6 px-4 max-w-7xl mx-auto">
          <Link to="/events" className="relative h-64 rounded-2xl overflow-hidden group border border-white/10 hover:border-bbq-red/50 transition-all duration-300">
            ...
            <img 
                src={settings.homeScheduleCardImage || "https://images.unsplash.com/photo-1565123409695-7b5ef63a2efb?auto=format&fit=crop&w=800&q=80"}
                alt="Events" 
          ...
          <Link to="/menu" className="relative h-64 rounded-2xl overflow-hidden group border border-white/10 hover:border-bbq-red/50 transition-all duration-300">
            <div className="absolute inset-0 bg-gradient-to-t from-black via-black/50 to-transparent z-10" />
            <img src={settings.homeMenuCardImage || "https://images.unsplash.com/photo-1594212699903-ec8a3eca50f5?auto=format&fit=crop&w=800&q=80"} alt="Menu" className="absolute inset-0 w-full h-full object-cover group-hover:scale-110 transition duration-700" onError={handleImageError} />
            <div className="absolute bottom-0 left-0 w-full p-8 z-20">
                <div className="flex items-center gap-3 mb-2">
      ...
      <section className="py-12 border-t border-gray-900 bg-black/20 overflow-hidden relative">
        <div className="max-w-7xl mx-auto px-4 mb-8 flex items-center justify-between relative z-10">
            ...
            <a href="https://facebook.com/bizos" target="_blank" className="text-xs font-bold text-white border border-white/20 px-4 py-2 rounded-full hover:bg-white hover:text-black transition">
                Follow Page
            </a>
        </div>
