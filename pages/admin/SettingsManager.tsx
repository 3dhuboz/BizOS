...
import { generateMarketingImage } from '../../services/ai';
                      ...
                      <div className="flex gap-2">
                          ...
                          <button type="button" disabled={aiStatus === 'saving'}
                              ...
                              onClick={() => {
                                  ...
                                  import('../../services/ai').then(m => m.setAiApiKey(key));
...
{`# Create database
npx wrangler d1 create bizos-db

# Apply schema
npx wrangler d1 execute bizos-db --remote --file=schema.sql
