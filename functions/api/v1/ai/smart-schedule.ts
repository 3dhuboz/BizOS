...
export const onRequest = async (context: any) => {
  ...
  try {
    ...
    const prompt = `You are a world-class social media strategist for "BizOS", a mobile low-and-slow BBQ business in Ipswich/Brisbane, QLD Australia. You specialise in authentic food brand storytelling that drives real sales.

=== BUSINESS CONTEXT ===
BizOS operates a pre-order model: customers pre-order from a fixed menu, the pitmaster smokes everything fresh on cook days, and customers pick up. It's limited, high-quality, community-driven.
